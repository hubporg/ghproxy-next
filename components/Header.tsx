      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${isDark ? "border-gray-800" : "bg-[#ffffff]"}`}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`w-8 h-8 transition-colors ${isDark ? "fill-white" : "fill-black"}`} aria-hidden="true">
          ...
          <div className="flex items-center space-x-8">
            <nav className="hidden md:flex space-x-8">
              <a className="text-gray-600 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white transition-colors font-medium" href="https://cdn.jsdelivr.net/gh/521xueweihan/GitHub520@main/hosts" target="_blank" rel="noreferrer">
                GitHub Host
              </a>
              <a className="text-gray-600 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white transition-colors font-medium" href={siteConfig.links.donate} target="_blank" rel="noreferrer">
                捐赠
              </a>
            </nav>

            {/* Feedback Link */}
            <a className="w-6 h-6 flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity" title="支持与反馈" href={siteConfig.links.contact} target="_blank" rel="noreferrer">
